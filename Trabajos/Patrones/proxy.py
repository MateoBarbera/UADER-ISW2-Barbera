...
class RealSubject(Subject):
    ...
    def request(self) -> None:
        print("RealSubject: Solicitud de tramitación.")
...
class Proxy(Subject):
    ...
    def check_access(self) -> bool:
        print("Proxy: Comprobación del acceso antes de disparar una solicitud real.")
        return True
...
if __name__ == "__main__":
    print("Cliente: Ejecutando el codigo del cliente con asunto real:")
